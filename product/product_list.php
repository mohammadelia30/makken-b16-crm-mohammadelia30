    ...
    <ul class="nav nav-pills ">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="../users/user_list.html">لیست کاربران</a></li>
          <li><a class="dropdown-item" href="../users/user_add.html">افزودن کاربر</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" href="#">محصولات</a>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="./product_list.html">لیست محصولات</a></li>
          <li><a class="dropdown-item" href="./product_add.html">افزودن محصول</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
  ...
  <table class="table table-dark">
    ...
    <tbody>
      <tr>
        <td>لباس</td>
        <td>200/000 تومان</td>
        <td><input type="color" class="form-control form-control-color" id="pwd" value="#774520" name="color" readonly>
        </td>
        <td>موجود</td>
        <td>200</td>
