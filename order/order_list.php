  ...
  <div class="container mt-3 panel">
    <ul class="nav nav-pills ">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="./order_list.php">لیست سفارشات</a></li>
          <li><a class="dropdown-item" href="./order_add.php">افزودن سفارش</a></li>
        </ul>
      </li>
      <li class="nav-item">
  ...
  <table class="table table-dark">
    ...
    <?php
      ...
      <tr>
        ...
        <td><a href="./order_edit.php?id=<?php echo $row["id"]?>"><button class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg"
