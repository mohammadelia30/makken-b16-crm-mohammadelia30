  ...
  <div class="container mt-3 panel">
    <ul class="nav nav-pills ">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="./order_list.html">لیست سفارشات</a></li>
          <li><a class="dropdown-item" href="./order_add.html">افزودن سفارش</a></li>
        </ul>
      </li>
      <li class="nav-item">
  ...
  <table class="table table-dark">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="./order_edit.html"><button class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg"
