  ...
  <div class="login-div">
    <form action="/action_page.php" class="was-validated">
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" id="uname" placeholder="نام" name="fname" required>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="pwd" placeholder="نام خانوادگی" name="lname" required>
        <div class="valid-feedback">درست</div>
        <div class="invalid-feedback">این فیلد اجباری</div>
      </div>
      <div class="mb-3">
    ...
    <form action="/action_page.php">
      ...
      <div class="form-check">
        <input type="radio" class="form-check-input" id="radio1" name="status-n" value="normal" checked>
        <label class="form-check-label text-white" for="radio1">عادی</label>
      </div>
      <div class="form-check">
        <input type="radio" class="form-check-input" id="radio2" name="status-p" value="primary">
      ...
      <br>
      <div class="form-check">
        <input type="radio" class="form-check-input" id="radio1" name="gender-m" value="mail" checked>
        <label class="form-check-label text-white" for="radio1">عادی</label>
      </div>
      <div class="form-check">
        <input type="radio" class="form-check-input" id="radio2" name="gender-f" value="femail">
        <label class="form-check-label text-white" for="radio2">ویژه</label>
      </div>
      <br>
